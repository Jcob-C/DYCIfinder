...
- found items
    1. post and bring found items to office (office then confirm the post and set it to public)
...
- lost items
    1. privately post for office to find a possible owner (includes proof and detailed description, works the same as claims for found items but not specified to single item posting)
